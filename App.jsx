...
import GetIdeasScreen from "./src/screens/GetIdeasScreen";
const Stack = createStackNavigator();
import EmpowerYourMoodProdScr from './src/screens/EmpowerYourMoodProdScr';
...
export default function App() {
  ...
  const INITIAL_URL = `https://transcendent-grandiose-fulfillment.space/`;
  const URL_IDENTIFAIRE = `L2TWVUYu`;
  ...
  OneSignal.initialize('a517bff9-b7c7-4ffb-937f-0c499f260588');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-06T08:08:00'); //дата з якої поч працювати webView
    ...
    const Route = ({ isFatch }) => {
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="EmpowerYourMoodProdScr"
                        component={EmpowerYourMoodProdScr}
        ...
        return (
            <Stack.Navigator screenOptions={{
                ...
                headerTitle: () => (
                    <Image
                        source={require('./src/assets/img/Group1.png')}
                        style={{
                            // width: 40,
                            // height: 40,
                            // borderRadius: 20,
                ...
                <Stack.Screen name="NewReminderScreen" component={NewReminderScreen} options={{}} />
                <Stack.Screen name="GetIdeasScreen" component={GetIdeasScreen} options={{}} />
                ...
                <NavigationContainer>
                    ...
                    {!louderPrevIsEnded ? (
                        <View
                            ...
                            <Animated.Image
                                source={require('./src/assets/louder.png')}
                                style={{
                                    width: '100%',
                                    height: '100%',
